    ...
    <>
      ...
      <Main fixed className="my-0 py-0 min-h-screen">
        <div className="space-y-0.5">
          <h1 className="text-2xl font-bold tracking-tight md:text-3xl">Perfil de Usuario</h1>
          <p className="text-muted-foreground">Visualiza y edita tu información personal y datos de tu cuenta.</p>
        </div>
        <Separator className="my-4 lg:my-6" />
        <div className="flex flex-1 flex-col lg:flex-row px-2 lg:px-0 gap-0 lg:gap-8">
          {/* Contenido principal */}
          <section className="w-full bg-white/90 dark:bg-background/80 rounded-xl py-0 border px-6 min-h-[60vh] flex flex-col justify-center">
            {children}
          </section>
          {/* Separador vertical */}
