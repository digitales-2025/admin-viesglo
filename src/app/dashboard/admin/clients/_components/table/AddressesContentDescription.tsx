...
export default function AddressesContentDescription({ row, setShowAddresses }: AddressesContentDescriptionProps) {
  ...
  return (
    <div className="bg-card rounded-xl border px-1 h-[380px] overflow-hidden">
      {/* Header del panel */}
      ...
      <ScrollArea className="max-h-[300px] h-full">
        {hasAddresses ? (
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 px-6 pb-2">
                ...
                <div key={idx} className="group relative">
                  <div className="px-5 py-3 rounded-xl border bg-gradient-to-br from-muted/20 to-muted/10 hover:from-muted/30 hover:to-muted/20 transition-all duration-200 h-full">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center gap-2">
                        <div
                          className={cn("h-2 w-2 rounded-full", address.isActive ? "bg-emerald-500" : "bg-destructive")}
                        />
                        <DropdownMenu>
