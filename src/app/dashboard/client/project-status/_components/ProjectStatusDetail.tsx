...
import { useProjectStore } from "@/app/dashboard/admin/tracking/_hooks/useProjectStore";
import AlertMessage from "@/shared/components/alerts/Alert";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/shared/components/ui/card";
import ProjectStatusServices from "./ProjectStatusServices";
      ...
      <CardContent className="flex-grow flex flex-col min-h-0 px-3 pb-3 sm:px-6 sm:pb-6">
        <div className="flex flex-col gap-4 sm:gap-6 h-full">
          ...
          <div className="flex-grow flex flex-col min-h-0">
            <ProjectStatusServices project={selectedProject} />
          </div>
        </div>
      </CardContent>
    </Card>
