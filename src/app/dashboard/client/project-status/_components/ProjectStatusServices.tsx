...
import { useServicesProject } from "@/app/dashboard/admin/tracking/_hooks/useServicesProject";
import { ProjectResponse } from "@/app/dashboard/admin/tracking/_types/tracking.types";
...
import ProjectStatusServiceCard from "./ProjectStatusServiceCard";
...
const ProjectStatusServices = memo(function ProjectServices({ project }: ProjectServicesProps) {
        ...
        <ScrollArea className="flex-grow  bg-muted rounded-2xl p-2 relative">
          ...
          <div className="flex flex-col gap-2">
            {services.map((service) => (
              <ProjectStatusServiceCard key={service.id} service={service} />
            ))}
          </div>
        </ScrollArea>
      ) : (
...
export default ProjectStatusServices;
