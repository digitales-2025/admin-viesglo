...
import { useDownloadEvidence } from "@/app/dashboard/admin/tracking/_hooks/useActivitiesProject";
import { FileType, ProjectActivityResponse } from "@/app/dashboard/admin/tracking/_types/tracking.types";
import {
  StatusProjectActivity,
  StatusProjectActivityColor,
  StatusProjectActivityOptions,
} from "@/app/dashboard/admin/tracking/[serviceId]/_types/activities.types";
