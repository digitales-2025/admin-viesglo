...
import { Briefcase, Calendar, Eye, FileText, Shell, Stethoscope, User } from "lucide-react";

import { BackButton } from "@/app/dashboard/admin/medical-records/_components/BackButton";
import { MedicalRecordDetails } from "@/app/dashboard/admin/medical-records/_components/detalle/medical-record-editor";
import { useMedicalRecord } from "@/app/dashboard/admin/medical-records/_hooks/useMedicalRecords";
        ...
        <Card>
          <CardContent className="py-8">
            ...
            <div className="flex justify-center mt-4">
              <Link href="/dashboard/client/client-medical-records">
      ...
      <div className="container py-6 pb-24">
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <BackButton href={`/dashboard/client/client-medical-records/${id}/details`} />
            <h1 className="text-2xl font-bold">Editar Detalle del Registro Médico</h1>
          </div>
          <Link href={`/dashboard/client/client-medical-records/${id}/details`} prefetch={true} passHref>
