...
} from "@/app/dashboard/admin/certificates/_actions/certificates.actions";
import { CertificateResponse, DocumentTypeLabel } from "@/app/dashboard/admin/certificates/_types/certificates.types";
