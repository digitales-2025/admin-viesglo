  ...
  "inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        ...
        success: "bg-emerald-100 border-none text-emerald-500 [a&]:hover:bg-emerald-600 font-semibold",
        error: "bg-rose-100 border-none text-rose-500 [a&]:hover:bg-rose-600 font-semibold",
        warning: "bg-yellow-100 border-none text-yellow-500 [a&]:hover:bg-yellow-600 font-semibold",
        info: "bg-blue-100 border-none text-blue-500 [a&]:hover:bg-blue-600 font-semibold",
        muted: "bg-gray-100 border-none text-gray-500 [a&]:hover:bg-gray-600 font-semibold",
