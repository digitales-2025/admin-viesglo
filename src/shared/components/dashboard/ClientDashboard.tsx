...
import { useClient } from "@/app/dashboard/admin/clients/_hooks/useClients";
import { useMedicalRecords } from "@/app/dashboard/admin/medical-records/_hooks/useMedicalRecords";
import { useProjectsPaginated } from "@/app/dashboard/admin/tracking/_hooks/useProject";
import {
  ProjectStatus,
  ProjectStatusColors,
  ProjectStatusLabels,
} from "@/app/dashboard/admin/tracking/_types/tracking.types";
