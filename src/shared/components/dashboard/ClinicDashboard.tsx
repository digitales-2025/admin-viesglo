...
import { AlertCircle, Building, Building2, CheckCircle2, ClipboardList, Mail, MapPin, Phone } from "lucide-react";

import { useCurrentUser } from "@/app/(public)/auth/sign-in/_hooks/useAuth";
import { useClientsByClinic } from "@/app/dashboard/admin/clients/_hooks/useClients";
import { useClinic } from "@/app/dashboard/admin/clinics/_hooks/useClinics";
import { useMedicalRecords } from "@/app/dashboard/admin/medical-records/_hooks/useMedicalRecords";
      ...
      <Tabs defaultValue="dashboard" className="w-full">
        ...
        <TabsContent value="dashboard" className="space-y-6 mt-6">
          ...
          <Card>
            ...
            <CardFooter>
              <Link href="/dashboard/clinic/registers" className={cn(buttonVariants({ variant: "outline" }), "w-full")}>
          ...
          <Card>
            ...
            <CardContent>
              {isLoadingClients ? (
                ...
                <div className="text-center py-8 text-muted-foreground">No hay clientes asignados a esta clínica</div>
              )}
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="clinic" className="space-y-6 mt-6">
          <Card>
            ...
            <CardFooter>
              <Link href="/dashboard/clinic/settings" className={cn(buttonVariants({ variant: "outline" }), "w-full")}>
                Editar información
              </Link>
            </CardFooter>
          </Card>
